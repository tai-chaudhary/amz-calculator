...
export default function BuildMonthPage({ months, settings, stockItems = [], savedProducts, overheads, onSaveMonth, onUpdateMonth, onDeleteMonth, onRenameMonth, loading }) {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-[28px] leading-tight">Build a Month</h1>
          <p className="text-sm text-ink/50 mt-1">Forecast monthly revenue, costs, and full P&L</p>
        </div>
...
function MonthEditor({ month, monthName, settings, stockItems = [], savedProducts, fixedOverheads, onUpdate, onDelete, onRename }) {
  ...
  return (
    <div>
        ...
        <div className="flex items-center gap-2">
          {renamingMonth ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="text-ink/30 hover:text-ink/55 text-xs" onClick={()=>{setRenamingMonth(true);setRenameVal(monthName||month.name)}} title="Rename">✏️</button>
            </div>
          )}
        </div>
        <div className="flex gap-2">
      ...
      <div className="flex gap-1 bg-ink/5 rounded-xl p-1 mb-5 w-fit">
        {tabs.map((t) => (
      ...
      {tab === 'products' && (
        <div>
          <div className="space-y-3 mb-4">
            ...
            {items.length === 0 && (
              <div className="text-center py-8 text-ink/45 text-sm bg-white border border-rule rounded-xl">
      ...
      {tab === 'pl' && (
        <div className="card">
          ...
          <div className="flex justify-between items-center py-2 px-3 bg-warn/5 border border-warn/20 rounded-lg mt-2">
            <div>
          ...
          {/* Gross profit line */}
          <div className="flex justify-between items-center py-3 my-1 bg-paper rounded-lg px-3">
          ...
          {/* Net profit line */}
          <div className="flex justify-between items-center py-3 mt-2 bg-paper rounded-lg px-3">
        ...
        <div className="fixed inset-0 bg-black/50 flex items-start justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl w-full max-w-md my-8 shadow-2xl">
            ...
            <div className="px-6 py-4">
              ...
              {/* Upfront cost */}
              <div className="flex justify-between items-center py-2 px-3 bg-warn/5 border border-warn/20 rounded-lg mt-2 mb-3">
                <div>
                  <span className="text-sm font-medium text-warn">Upfront cost</span>
              ...
              {/* Gross profit */}
              <div className="flex justify-between items-center py-3 bg-paper rounded-lg px-3 mt-1">
